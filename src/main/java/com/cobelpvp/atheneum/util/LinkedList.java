...
public class LinkedList<E> extends AbstractSequentialList<E> implements List<E>, Deque<E>, Cloneable, Serializable {
    ...
    private LinkedList.Entry<E> addBefore(E e, LinkedList.Entry<E> entry) {
        LinkedList.Entry<E> newEntry = new LinkedList.Entry(e, entry, entry.previous);
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        for (LinkedList.Entry e = this.header.next; e != this.header; e = e.next) {
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        s.defaultReadObject();
        int size = s.readInt();
        this.header = new LinkedList.Entry(null, (LinkedList.Entry) null, (LinkedList.Entry) null);
